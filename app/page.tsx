...
export default function Home() {
  return (
  <main className="w-full p-20 overflow-hidden relative md:p-10 max-sm:px-5 bg-gradient-to-r from-gray-800 via-transparent to-transparent" style={{ backgroundImage: "url('/Hero.jpg')", opacity: 0.9 }}>

...
const Footer = ({contactButton} : FooterProps) => {
  return (
    <footer className="bg-primary-color-default text-primary-color-100 px-20 md:px-10 max-sm:px-2">
        {
            contactButton && <CustomButton title="Schedule a call" linkURL="/contact" btnType='button' customButtonStyles='btn-outline rounded-full my-10  text-white hover:scale-100 px-24 max-sm:px-10'/>
        }
